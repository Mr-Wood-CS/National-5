...
!!! note "Structure diagram symbols"
    ...
    <figure markdown="span">
      ![Structure Diagram Symbols](../../_assets/Images/1-sdd-004.png){ width="700" }
    </figure>
...
!!! example "Sequencing shown as a structure diagram"
    ...
    <figure markdown="span">
      ![Sequencing Structure Diagram](../../_assets/Images/1-sdd-006.png){ width="700" }
    </figure>
...
!!! note "Flowchart symbols"
    ...
    <figure markdown="span">
      ![Flowchart Symbols](../../_assets/Images/1-sdd-007.png){ width="700" }
    </figure>
...
!!! example "Sequencing shown as a flowchart"
    ...
    <figure markdown="span">
      ![Sequencing Flowchart](../../_assets/Images/1-sdd-010.png){ width="500" }
    </figure>
