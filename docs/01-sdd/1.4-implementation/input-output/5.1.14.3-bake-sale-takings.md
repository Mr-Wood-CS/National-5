...
1. set up the item names array and price variables
...
The array is only storing the item names.

The price variables store the cost of each item.

Remember:

- use the item names from the array when displaying the summary
- use the price variables in your calculations
