...
==__The database must also be able to:__ search books by title, author, or genre; sort results alphabetically or by date; check if a book is available; list all books borrowed by a pupil; and identify overdue books.==
