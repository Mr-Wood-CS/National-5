...
-- Saved Access queries converted for MySQL/MariaDB.
-- Time-only Access criteria such as #10:00# are written as TIME strings.

-- Task 5(b): Insert Ben Wyvis Primary
INSERT INTO `DeliverySchools` (`SchoolName`, `Address`, `Town`, `DeliveryTime`, `EmployeeID`)
VALUES ('Ben Wyvis Primary', 'Leanaig Road', 'Dingwall', '10:00:00', 2419);

-- Task 6: Insert Driver Zoe Mackenzie
INSERT INTO `DeliveryDrivers` (`Name`, `EmployeeID`, `Age`)
